	...
	<div class="register-photo" style="background-color: #ffffff;">
		<div class="form-container">
			<div class="image-holder"
				style="background-image: url(${contextPath}/img/chatbot-detailsimage.png)"></div>

			<form>
				<h2 class="text-center">
					<strong>Descrição do Chatbot</strong>
				</h2>
				<div class="form-group">
					<label>Nome:</label> <label class="label label-default">${bot.name}</label>
				</div>
				<div class="form-group">
					<label>Mensagem de boas vindas:</label> <label
						class="label label-default">${bot.welcome_msg}</label>
				</div>
				<div class="form-group">
					<label>mensagem de despedida:</label> <label
						class="label label-default">${bot.farewell_msg}</label>
				</div>
				<div class="form-group">
					<label>Tempo de espera:</label> <label class="label label-default">${bot.downtime}</label>
				</div>
				<div class="form-group">
					<label>Mensagem padrão:</label> <label class="label label-default">${bot.default_answer}</label>
				</div>
				<div class="form-group">
					<label>Segmentos:</label> <label class="label label-default">${bot.segments}</label>
				</div>
